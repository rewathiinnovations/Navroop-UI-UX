  ...
  return (
    <button
      ...
      className={cn(
        ...
        size === 'default' && 'rounded-8 p-6',
        size === 'large' && 'rounded-10 p-8 gap-2',
        variant === 'primary' && 'text-accent-white active:[scale:0.995]',
        ['secondary', 'tertiary', 'playground'].includes(variant) &&
          'text-accent-black active:[scale:0.99] active:bg-black-alpha-7',
        variant === 'secondary' && 'bg-black-alpha-4 hover:bg-black-alpha-6',
        variant === 'tertiary' && 'hover:bg-black-alpha-4',
        variant === 'playground' && [
