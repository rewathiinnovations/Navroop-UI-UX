        ...
        navigationItems={[
          {
            ...
            items: [
              {
                icon: <RenderEndpointIcon icon={EndpointsScrape} alwaysHeat triggerOnHover />,
                label: 'Scrape',
              ...
              {
                icon: <RenderEndpointIcon icon={EndpointsCrawl} alwaysHeat triggerOnHover />,
                label: 'Crawl',
              ...
              {
                icon: <RenderEndpointIcon icon={EndpointsSearch} alwaysHeat triggerOnHover />,
                label: 'Search',
              ...
              {
                icon: <RenderEndpointIcon icon={EndpointsMap} alwaysHeat triggerOnHover />,
                label: 'Map',
              ...
              {
                icon: <RenderEndpointIcon icon={EndpointsMcp} alwaysHeat triggerOnHover />,
                label: 'MCP',
