      ...
      <div>
        ...
        <div className="p-4">
          <label
            ...
            className="block text-xs font-medium text-[var(--studio-muted)] mb-2"
          >
            Site to clone
          </label>
          <input
            ...
            className="w-full px-3 py-2 text-xs text-[var(--studio-fg)] bg-[var(--studio-bg)] rounded border border-[var(--studio-line)] focus:border-[var(--studio-accent)] focus:outline-none focus:ring-1 focus:ring-[var(--studio-accent)] placeholder:text-[var(--studio-faint)] disabled:opacity-50"
          />
        </div>
