...
const Button = forwardRef<HTMLButtonElement, Props>(
  (
    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === 'primary' && [
            ...
            // `bg-heat-90`, not `bg-[color:var(--heat-90)]`: the arbitrary form
            // silently produced nothing while --heat-90 was undeclared, and only
            // the utility form is checked against the colour manifest (F-833).
            !isNonInteractive && 'hover:bg-heat-90 active:[scale:0.995]',
      ...
      >
        {variant === 'primary' && <div className="overlay button-background !absolute" />}
