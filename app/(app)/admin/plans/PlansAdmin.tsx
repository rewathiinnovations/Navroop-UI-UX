  ...
  return (
    ...
    >
      ...
      <form onSubmit={onCreate} className="mt-28 grid gap-12 sm:grid-cols-3">
        <h2 className="sm:col-span-3 text-[18px] font-medium text-[var(--studio-fg)]">
          Create plan
        </h2>
        <input
          name="key"
          required
          placeholder="key (pro-plus)"
          className="h-40 rounded-10 border border-[var(--studio-line)] px-12"
        />
        <input
          name="name"
          required
