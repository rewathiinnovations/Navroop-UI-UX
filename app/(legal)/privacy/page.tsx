    ...
    <article className="space-y-20 text-[15px] leading-6 text-[var(--studio-fg)]">
      ...
      <div>
        ...
        <p className="mt-8 text-[13px] text-[var(--studio-muted)]">
          Draft dated 17 August 2026. Version 2026-08-17. Written with India’s Digital Personal Data
          Protection Act, 2023 in mind — still a draft, not legal advice.
        </p>
      </div>
      ...
      <section className="space-y-8">
        ...
        <ul className="list-disc space-y-4 pl-20">
          <li>
            Account details: name, email, password hash, role, avatar, and terms acceptance time.
          </li>
          <li>Prompts you type, project names, plans, chat history, and generation events.</li>
          <li>
            Generated code: the project&rsquo;s current files and checkpoints (object snapshots).
          </li>
          <li>Published sites: deploy records, DNS hostnames, and custom domains you attach.</li>
          <li>
            Optional connectors: GitHub App installation, Cloudflare zone, Coolify servers (secrets
            encrypted).
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-8">
        ...
        <p>
          Application data lives in the workspace Postgres database. File snapshots and images use
          the configured object store (local disk in development, or the ElasticLake / S3-compatible
          bucket in production). Database backups go to a separate backup bucket, not the live asset
          bucket.
        </p>
      </section>
      ...
      <section className="space-y-8">
        ...
        <ul className="list-disc space-y-4 pl-20">
          ...
          <li>
            ...
            <code>CHECKPOINT_RETENTION_DAYS</code>).
          </li>
          <li>
            Soft-deleted projects are purged after 30 days (<code>PURGE_DELETED_DAYS</code>).
          </li>
      ...
      <section className="space-y-8">
        ...
        <p>
          You can ask for a copy of your data or for deletion from Settings → Profile. The request
          is emailed to workspace administrators. Navroop does not delete an account automatically.
          Administrators should confirm identity before acting.
        </p>
      </section>
    </article>
  );
