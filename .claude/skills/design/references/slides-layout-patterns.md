...
python "$SKILLS_DIR/design-system/scripts/search-slides.py" "metrics dashboard" -d layout

# Contextual recommendation
python "$SKILLS_DIR/design-system/scripts/search-slides.py" "traction slide" \
