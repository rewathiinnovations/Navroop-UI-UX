...
python "$SKILLS_DIR/design-system/scripts/search-slides.py" "problem agitation" -d copy

# Get emotion-appropriate formula
python "$SKILLS_DIR/design-system/scripts/search-slides.py" "urgency cta" -d copy
```
